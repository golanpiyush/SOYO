...
| Service      | Status |
|-------------|--------|
| 🎥 Movies   | ![Movies API](https://img.shields.io/website?url=https%3A%2F%2Fdb.cineby.aphp%2F3&label=Movies%20API&style=flat-square&up_message=buildpassing✅&down_message=buildfailing❌&logo=movie) |
